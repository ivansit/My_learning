...
# 1. Function by default params
def print_params(a = 1, b = 'string', c = True):
    print(a, b, c)

print_params() # Without arguments
print_params(b = False) # 1 arg + 2 by default
print_params(2, 'str') # 2 args + 1 by default
print_params(3.14, 76, 'Mike') # with 3 args
print_params(b = 25)  # +++
print_params(c = [1, 2, 3])  # +++

# 2. Unpacking
values_list = [1, 'Urban', False]
values_dict = {'a': 2, 'b': True, 'c': 'Moscow'}

print_params(*values_list)
print_params(**values_dict)

# 3. Unpacking + individual parameters
values_list_2 = ['Dalnerechensk', 25]
print_params(*values_list_2, 42)     # Everything works correctly!
