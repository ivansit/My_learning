...
def calculate_structure_sum(data_structure):
    ...
    if isinstance(data_structure, (int, float)):
        summ_of_objects += data_structure
    if isinstance(data_structure, str):
        summ_of_objects += len(data_structure)
    elif isinstance(data_structure, (list, tuple, set)):
        for i in data_structure:
            summ_of_objects += calculate_structure_sum(i)
    elif isinstance(data_structure, dict):
        for key, value in data_structure.items():
            summ_of_objects += calculate_structure_sum(key)
            summ_of_objects += calculate_structure_sum(value)

    return summ_of_objects
