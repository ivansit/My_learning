...
#2
my_dict = {'Ivan': '1991', 'Michael': '1988', 'Aleksander': '1956', 'Svetlana': '1965'}
print(my_dict)
print(my_dict['Ivan'])
print(my_dict.get('Pavel', 'There is no such person'))
my_dict.update({'Oleg': 1987, 'Inna': 1996})
a = my_dict.pop('Aleksander')
print(a)
print(my_dict)
print('-----------------------------------------------------------------------------------------------------------------')

#3
my_set = {1, 2, 3, 'String', 3.14, 1, 2, 3}
print(my_set)
my_set = {1, 2, 3, 'String', 3.14, 1, 2, 3, (4, 5, 6), 'str'}
my_set.discard(1)
print(my_set)